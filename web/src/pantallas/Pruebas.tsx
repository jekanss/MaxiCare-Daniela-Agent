...
export default function Pruebas() {
  ...
  return (
    <div className="flex-1 flex flex-col min-w-0 overflow-hidden" style={{ fontFamily: SP, backgroundColor: '#F9FAFB' }}>
      ...
      <div className="shrink-0 flex items-center gap-3 px-4 sm:px-8 py-2.5" style={{ backgroundColor: '#92400E' }}>
      ...
      <header className="shrink-0 flex items-center justify-between px-4 sm:px-8 py-4 border-b" style={{ backgroundColor: '#FFFFFF', borderColor: '#E5E7EB' }}>
        <div>
      ...
      <form onSubmit={enviar} className="shrink-0 px-4 sm:px-8 py-4 border-t" style={{ backgroundColor: '#FFFFFF', borderColor: '#E5E7EB' }}>
